...
module.exports = function(config) {
  ...
  if(this.config.middleware.error) {
    if(!_.isArray(this.config.middleware.error)) {
      this.config.middleware.error = [this.config.middleware.error];
    }
    this.config.middleware.error.forEach(function(middleware){
      app.use(middleware);
    });
  } else {
  ...
  if(_.isFunction(this.config.middleware.notFound)) {
    app.use(this.config.middleware.notFound);
  } else {
